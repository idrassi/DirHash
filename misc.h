...
EXPLICIT_INLINE uint32 ByteReverseWord32 (uint32 value)
{
...
EXPLICIT_INLINE uint64 ByteReverseWord64(uint64 value)
{
...
EXPLICIT_INLINE void CorrectEndianess(uint64 *out, const uint64 *in, size_t byteCount)
